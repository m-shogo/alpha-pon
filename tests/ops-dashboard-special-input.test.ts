...
for (const malformed of [
  ...
  { generatedAt: asOf, today: asOf, healthStatus: "ok", actionItems: [{ priority: "ok", title: "no review due" }], reviewDue: { overdue: 0, historicalSeedOverdue: 0, priceDataPending: 0, dueToday: 1, dueThisWeek: 0 } },
