...
for (const malformed of [
  ...
  { status: "completed", steps: [{ name: "daily" }] },
  { status: "completed", steps: [{ status: "ok" }] },
  { status: "completed", steps: [{ name: "", status: "ok" }] },
  { status: "completed", steps: [{ name: " daily ", status: "ok" }] },
  { status: "completed", steps: [{ name: "daily", status: "" }] },
  { status: "completed", steps: [{ name: "daily", status: " ok " }] },
