...
assert.equal(mixed.warning, 'generatedCompanyRules: invalid_entries (9)')
...
console.log('generated-rule-input: malformed rows, PIT generatedAt provenance, and ambiguous generatedRuleId identities isolated OK')
