...
assert.throws(() => mapJQuantsFreeQuote({
  ...
  retrievedAt: "2026-05-14T14:59:59.999999998Z",
...
const exactBoundary = mapJQuantsFreeQuote({
  ...
  quote,
  delayDays: 0,
  retrievedAt: "2026-05-14T14:59:59.999999999Z",
  firstExecutableAt: "2026-05-14T15:00:00Z",
  ingestionRunId: "fixture-exact-observed-boundary",
});
assert.equal(exactBoundary.observedAt, "2026-05-14T23:59:59.999999999+09:00");
