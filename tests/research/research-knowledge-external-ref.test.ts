...
const epistemicRefErrors = validate({
  schemaVersion: 1,
  ontologyVersion: "research-knowledge-v1",
  id: "relation-claim-duplicate-authority",
...
assert.ok(
  epistemicRefErrors.some((error) => error.path === "sourceType"),
  "Claim/Evidence/Outcome relationships stay in their existing authorities instead of being duplicated in Research Relation v1",
);

console.log("research knowledge external refs: authority boundaries preserved");
