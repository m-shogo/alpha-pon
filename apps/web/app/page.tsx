      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: 12 }}>
          <div>
            ...
            <h1 style={{ margin: 0, fontFamily: 'var(--display)', fontWeight: 700, fontSize: 27, color: 'var(--accent)', letterSpacing: 0.2 }}>
              alpha-pon
            </h1>
          </div>
      ...
      <div style={{ padding: '16px 16px 0' }}>
        ...
        <div style={{ display: 'flex', gap: 9, marginTop: 9 }}>
          ...
          <Link href="/watchlist" style={{
            ...
            <span style={{ width: 32, height: 32, borderRadius: 10, background: 'var(--lavender-soft)', color: 'var(--lavender-deep)', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 }}>
              <Icon name="watch" size={17} />
            </span>
            <span>
              <span style={{ display: 'block', fontSize: 13, fontWeight: 800, color: 'var(--ink)' }}>ウォッチリスト</span>
              <span style={{ display: 'block', fontSize: 11, fontWeight: 700, color: 'var(--lavender-deep)' }}>
                {data.candidates.length} 銘柄
              </span>
            </span>
          </Link>
        </div>
        ...
        {list.length === 0 ? (
          <div style={{ textAlign: 'center', padding: '32px 0', color: 'var(--ink-3)', fontSize: 13, fontWeight: 600 }}>
            ...
            <p style={{ marginTop: 8, fontSize: 12 }}>
              ルートで <code style={{ background: 'var(--surface-2)', padding: '2px 6px', borderRadius: 4 }}>pnpm ui:data</code> を実行してください
            </p>
          </div>
        ) : (
