...
Base main: `a58ff7ff94dec77214550590606fe023cde81900`
...
- current `research/knowledge_catalog/research_components/` contained only five misconduct phase components; no fixture/cohort/calibration object matching these sources was present;
- the canonical Catalog README states missing type directories mean zero records;
- no `studies/` directory currently exists, therefore no canonical Study is being duplicated by this proposal.
