...
export const MARKET_LESSONS: MarketLesson[] = [
  ...
  },
  {
    ...
    chain: [
      "空売り比率が極端に高い",
      "SNSで共通ストーリーが形成される",
      "個人投資家の買いとオプション取引が増える",
      "空売りの買い戻しが価格上昇を加速する",
      "流動性・取引制限・反動下落リスクが高まる",
    ],
  ...
  },
  {
    ...
    chain: [
      "AI利用が増え計算資源需要が増える",
      "GPU/半導体/サーバー/データセンター需要が急増する",
      "電力・冷却・用地・供給網がボトルネックになる",
      "実際に受注・売上化できる企業が上がる",
      "周辺の名ばかりAI銘柄は過熱後に失速しやすい",
    ],
