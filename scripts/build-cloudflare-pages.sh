...
run_ts scripts/verify-market-event-event-type-identity.ts
...
run_ts scripts/verify-market-event-projection-metadata-instants.ts
...
run_ts scripts/verify-market-event-source-url-provenance.ts
